  ...
  return (
    <section className="flex flex-col lg:flex-row dark:text-slate-100 items-center">
      <div className="text my-5">
        <h1 className="text-5xl font-bold">The Ultimate Products Store</h1>
        <p className="text-2xl my-7 px-1 dark:text-slate-300">
          ShopMaster: The Leading Source for all your shoping needs. Explore the
          latest and highest-rated digital products. Stay ahead with the newest
